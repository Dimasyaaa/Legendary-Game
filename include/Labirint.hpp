...
class Game {
private:
  std::string map[n][m];    ///< Массив, представляющий карту лабиринта
  ...
  std::string treasureSymbol; ///< Символ для отображения сокровища
  std::string playerSymbol;   ///< Символ для отображения игрока
...
private:
   ...
   *
   * Раскрывает клетки в радиусе 2 клеток от игрока
   */
